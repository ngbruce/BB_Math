...
namespace BBMath.Core
{
    ...
    /// 乘法题目生成策略
    /// </summary>
    public class MultiplicationStrategy : IProblemGenerationStrategy
    {
        ...
        public MultiplicationStrategy(Random random = null)
        {
        ...
        /// <param name="allowNegativeResult">是否允许负数结果（对乘法不适用）</param>
