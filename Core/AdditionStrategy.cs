...
namespace BBMath.Core
{
    ...
    /// 加法题目生成策略
    /// </summary>
    public class AdditionStrategy : IProblemGenerationStrategy
    {
        ...
        public AdditionStrategy(Random random = null)
        {
        ...
        /// <param name="allowNegativeResult">是否允许负数结果（对加法不适用）</param>
