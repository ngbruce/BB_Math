namespace BBMath.Application
{
    partial class frmPsw
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label4.Text = "请关注公众号，发送信息“密码”获取";
			// 
			// label5
			// 
			...
			this.label5.Text = "如果不懂该如何查看";
			// 
			// pictureBox1
			// 
			this.pictureBox1.Image = global::BBMath.Application.Properties.Resources.ori_WeChatQCode;
